  ...
  return (
    <div className="mb-20">
      <section className="max-w-screen-2xl mx-auto">
        <div className="px-10 sm:px-12 md:px-14 lg:px-16 py-20 bg-[var(--add-ons-base)] text-brown-800">
          <div className="flex flex-col space-y-14">
            ...
            >
              ...
              <p className="text-sm sm:text-lg text-justify sm:text-center">
                Shoonya Life is designed to ensure that your dynamic lifestyle
                is perfectly in sync with your mind, body, and soul. We aim to
                bring authentic yoga combined with lifestyle changes, spiritual
                ...
                <div className="bg-[var(--Brand-colors-Base)] p-6 flex gap-3 sm:gap-6 rounded-lg items-center shadow-lg transition-transform transform hover:scale-105">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-base font-satoshi text-justify sm:text-balance">
                      The connection people share with Earth can be best
                      expressed through meditation and Yoga as prime languages
                      and connect to nature at a deeper level.
                    </p>
                  </div>
                </div>
                <div className="bg-[var(--Brand-colors-Base)] p-6 flex gap-3 sm:gap-6 rounded-lg items-center shadow-lg transition-transform transform hover:scale-105">
