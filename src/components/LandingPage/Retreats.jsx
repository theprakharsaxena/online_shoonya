...
const Retreats = () => {
  ...
  return (
    <section className="px-10 sm:px-12 md:px-14 lg:px-16 py-20 bg-[#FFF7E3] relative">
      <div className="absolute bottom-0 left-0 hidden lg:flex">
        <img src="/home/retreat_bg_desgin_opp.png" className="h-[75vh]" />
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 sm:gap-8 w-full">
        ...
        <div className="col-span-2 flex flex-col sm:flex-row gap-8">
          <img
            ...
            alt="Lightbox 2"
            className="w-full object-cover min-h-[400px] sm:w-1/2 h-[calc(100vh/2.5)] sm:h-[calc(100vh/1.2)] rounded-lg"
          />
          <div className="flex flex-col gap-8 w-full sm:w-1/2">
            <img
              src="/home/lightbox.webp"
              alt="Lightbox"
              className="w-full object-cover min-h-[184px] h-[calc(100vh/5)] sm:h-[calc(100vh/2.55)] rounded-lg"
            />
            <img
