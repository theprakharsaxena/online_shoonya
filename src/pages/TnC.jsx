          ...
          <div className={styles.main}>
            <div className={styles.privacyWrapper}>
              ...
              <div className={styles.privacyContentDiv}>
                ...
                <p>
                  By accessing and using Shoonya's services, you agree to be
                  bound by these terms, which establish a contractual
                  relationship between you and Ekam Internet LLP. If you
              ...
              <div className={styles.privacyContentDiv}>
                ...
                <p>
                  ...
                  certified yoga teachers with individuals seeking authentic
                  yoga experiences, with a focus on catering to professionals in
                  the tech industry. Our platform facilitates the discovery,
                  booking, and management of yoga sessions.
                </p>
              </div>
              <div className={styles.privacyContentDiv}>
                <p className={TeacherHomeStyles.stepsHeading}>
                ...
                <div className={styles.list}>
                  ...
                  <p>
                    {" "}
                    <li>
                      All contents of the site, including but not limited to
                      texts, graphics, logos, and software, are the property of
                      Shoonya Life (Ekam Internet LLP) and are protected by
              ...
              <div className={styles.privacyContentDiv}>
                ...
                <p>
                  ...
                  the laws of Haryana, India, without regard to its conflict of
              ...
              <div className={styles.privacyContentDiv}>
                ...
                <p>
                  In the event of a dispute, efforts should be made to resolve
                  the matter amicably through informal negotiation. Failing
                  which, the dispute will be resolved through arbitration in
