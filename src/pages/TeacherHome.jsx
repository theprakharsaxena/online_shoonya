          ...
          <div className={`${styles.benefitSection} ${styles.stepsSection}`}>
            <div className={styles.benefitSectionWrapper}>
              ...
              <p className={`${styles.benefitSubheading2} ${utils.s18}`}>
                Join Shoonya Life - Amplify Your Impact: Unlock the opportunity
                to broaden your reach and enhance your teaching capabilities
                with Shoonya. By joining our platform, you gain access to a vast
