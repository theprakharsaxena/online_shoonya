      ...
      <div className={landingPageStyles.heroWrapper}>
        <div className={styles.headerSection}>
          <div className={styles.headerSectionLeft}>
            <p className={`${utils.s56} ${styles.heading}`}>
              Join Shoonya Life to broaden your teaching horizons and enrich the
              yoga community.
            </p>
          ...
          <div className={styles.steps}>
            <div className={styles.step}>
              ...
              <p className={styles.stepsSubheading}>
                Sign up and fill out your details along with a questionnaire to
                begin your journey with us. This initial step helps us
                understand your background, skills, and specific yoga expertise.
              </p>
            </div>
            <div className={styles.step}>
              <img src={videoIcon} alt="dollar_icon" />
              <p className={styles.stepsHeading}>Undergo Our Vetting Process</p>
              <p className={styles.stepsSubheading}>
                Our selection process involves a thorough vetting of your
                qualifications and teaching style to ensure a good fit within
                our community. This step maintains high standards and aligns
                instructors with participants' needs.
              </p>
            </div>
            <div className={styles.step}>
              ...
              <p className={styles.stepsSubheading}>
                ...
                community and share your yoga practice, inspiring wellness and
                balance.
              </p>
            </div>
          </div>
        ...
        <div className={`${styles.benefitSection} ${styles.stepsSection}`}>
          <div className={styles.benefitSectionWrapper}>
            ...
            <p className={`${styles.benefitSubheading2} ${utils.s18}`}>
              Join Shoonya Life - Amplify Your Impact: Unlock the opportunity to
              broaden your reach and enhance your teaching capabilities with
              Shoonya. By joining our platform, you gain access to a vast
              network of yoga enthusiasts seeking authentic experiences,
              providing you a unique opportunity to influence and expand your
              professional footprint. Connect with us and start transforming
        ...
        >
          ...
          >
            ...
            >
              If you're a yoga instructor interested in joining our platform and
              have questions, we provide detailed support to assist you. Feel
              free to contact us for more information on how to become part of
              our community.
            </p>
            <button
