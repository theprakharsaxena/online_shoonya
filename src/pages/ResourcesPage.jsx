    ...
    <>
      <div className="py-24 2xl:py-28">
        <div className={landingPageStyles.hero}>
          <div
            className={`${landingPageStyles.programsDiv} ${styles.resourceHeading}`}
          >
          ...
          <div className={styles.featuredResourcesWrapper}>
            <p className={`${styles.featuredResourcesHeading} ${utils.s24}`}>
              Featured Resources
            </p>
            <div className={styles.featuredResourcesDiv}>
              <div className={styles.featuredResourcesParentImgDiv}>
                <div
                  className={`${ProductPageStyles.productImgDiv} ${styles.resourceImgDiv}`}
                >
                ...
                <div className={styles.resourceHeadings}>
                  ...
                  <div className={EventCardStyles.infoSection}>
                    <p className={`${utils.s32} ${styles.blogSubheading}`}>
                      {heading}
                    </p>
                    <p>{subheading}</p>
                  </div>
              ...
              <div className={styles.featuredSubresourceDiv}>
                {alteredBlogsList.map((blog) => {
                  ...
                  return (
                    <div className={styles.featuredSubresource}>
                      ...
                      <div className={styles.featuredResourceInfo}>
                        ...
                        <div className={styles.featuredSubresourceTitle}>
                          <p className={styles.featuredResourceTitleTxt}>
                            {heading}
                          </p>
                        </div>
                        <div className={styles.readMore}>
              ...
              <div className={utils.wrapper}>
                <div className={landingPageStyles.programsDiv}>
                  ...
                  <div className={landingPageStyles.heading_btn}>
                    ...
                    >
                      <p>View all</p>{" "}
                      <img src={rightArrowSvg} alt="right_arrow" />
                    </button>
                  </div>
