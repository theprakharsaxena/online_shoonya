          ...
          <div className={styles.surveyMain}>
              ...
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    ...
                    <p className={utils.s36}>
                      1. Could you share where you’re joining us from? We’d love
                    ...
                    <div className={styles.input_submit}>
                      <div className={styles.surveyInputs}>
                        <div className={styles.inputDiv}>
                          ...
                          />
                          {errors?.location && (
                            <p className={utils.errors}>{errors?.location}</p>
                          )}
                        </div>
                      </div>
                      <div className={styles.navigateBtns}>
                        ...
                        <button
                          className={`${utils.btn1} ${styles.submitBtn}`}
                          onClick={() => validateStep1()}
                        >
                          Next <img src={rightArrow} alt="right_arrow" />
                        </button>
                      </div>
                    </div>
                  </div>
              ...
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    {/* <p className={`${utils.s48} ${styles.surveyHeading}`}>Find Your Balance, Embrace Wellness</p> */}
                    <p className={utils.s36}>
                      2. How old are you? This helps us understand the diversity
                      of our community.
                    </p>
                    <div className={styles.input_submit}>
                      <div className={styles.inputDiv}>
                        ...
                        />
                        {errors?.age && (
                          <p className={utils.errors}>{errors?.age}</p>
                        )}
                      </div>
                      <div className={styles.navigateBtns}>
                        <button
                        ...
                        >
                          ...
                          <img
                            src={rightArrow}
                            className={styles.leftArrowRotate}
                            alt="right_arrow"
                          />
                        </button>
                        <button
              ...
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    {/* <p className={`${utils.s48} ${styles.surveyHeading}`}>Find Your Balance, Embrace Wellness</p> */}
                    <p className={utils.s36}>
                      3. Reflecting on your typical day how often do you feel
                      physical discomfort?
                    </p>
                    <div className={styles.input_submit}>
                      <div className={styles.inputDiv}>
                        ...
                        <div className={styles.mcqDivs}>
                          {frequencyList.map((frequency) => (
                            <div className={styles.mcqDiv}>
                              ...
                              />
                              <label htmlFor={frequency} className={utils.s24}>
                                {frequency}
                              </label>
                            </div>
                          ))}
                          {errors?.frequency && (
                            <p className={utils.errors}>{errors?.frequency}</p>
                          )}
                        </div>
                      </div>
                      <div className={styles.navigateBtns}>
            ...
            {step === 4 && (
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    <p className={utils.s36}>
                      4. What types of physical discomfort are most frequent for
                    ...
                    <div className={styles.input_submit}>
                      <div className={styles.inputDiv}>
                        <div className={styles.mcqDivs}>
                          ...
                          {errors?.discomfort && (
                            <p className={utils.errors}>{errors?.discomfort}</p>
                          )}
                        </div>
                      </div>
                      <div className={styles.navigateBtns}>
              ...
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    {/* <p className={`${utils.s48} ${styles.surveyHeading}`}>Find Your Balance, Embrace Wellness</p> */}
                    <p className={utils.s36}>
                      5. On the spectrum of stress where do you find yourself
                      most days?
                    </p>
                    <div className={styles.input_submit}>
                      <div className={styles.inputDiv}>
                  ...
                  {errors?.age && <p className={utils.errors}>{errors?.age}</p>} */}
                        <div className={styles.mcqDivs}>
                          {stressLevelList.map((stressLevel) => (
                            <div className={styles.mcqDiv}>
                              <input
                                type="radio"
                                name="stresslevel"
                                ...
                                value={stressLevel}
                                className={utils.s24}
                                onChange={(e) => setStreeLevel(e.target.value)}
                              />
                              <label
                                htmlFor={stressLevel}
                                className={utils.s24}
            ...
            {step === 6 && (
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    <p className={utils.s36}>
                      6. Which aspects of your life would you like to enhance
                      through our wellness programs? (Select up to two)
                    </p>
                    <div className={styles.input_submit}>
                      <div className={styles.inputDiv}>
                        <div className={styles.mcqDivs}>
            ...
            {step === 7 && (
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    <p className={utils.s36}>
                      7. Balancing work and life can be tricky. How do you feel
                      about your current balance?
                    </p>
                    <div className={styles.input_submit}>
                      <div className={styles.inputDiv}>
                        <div className={styles.mcqDivs}>
                          {workLifeBalnceList.map((balance) => (
                            <div className={styles.mcqDiv}>
                              <input
                                type="radio"
                                name="balance"
                              ...
                              />
                              <label htmlFor={balance} className={utils.s24}>
                                {balance}
                              </label>
                            </div>
                          ))}
                          {errors?.balance && (
                            <p className={utils.errors}>{errors?.balance}</p>
                          )}
                        </div>
                      </div>
                      <div className={styles.navigateBtns}>
            ...
            {step === 8 && (
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    <p className={utils.s36}>
                      8. Have you practised yoga or meditation before? If so how
                      often do you engage with these practices?
                    </p>
                    <div className={styles.input_submit}>
                      <div className={styles.inputDiv}>
                        <div className={styles.mcqDivs}>
                          {engagementLevelsList.map((engagementLevel) => (
                            <div className={styles.mcqDiv}>
                              <input
                                type="radio"
              ...
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    {/* <p className={`${utils.s48} ${styles.surveyHeading}`}>Find Your Balance, Embrace Wellness</p> */}
                    <p className={utils.s36}>
                      9. It’s been great learning about you! To personalise your
                      journey and keep you informed about programs that can
                      truly benefit you could we have your name and email
                      address?
                    </p>
                    <div className={styles.input_submit}>
                      <div className={styles.surveyInputs}>
            ...
            {step === 10 && (
              <div className={styles.surveyLeft}>
                ...
                <div className={`${utils.container} ${styles.containerExtra}`}>
                  <div className={styles.surveyLeftContent}>
                    <p className={`${utils.s36} ${styles.surveyHeading}`}>
                      Thank you for sharing your thoughts with us! Based on your
                      answers we'll craft suggestions that truly fit your needs
                      and help you on your path to greater wellness. Look out
                      for tailored program recommendations coming your way soon.
                    </p>
                    <div className={styles.input_submit}>
                      <button
                        className={`${utils.btn1} ${styles.submitBtn}`}
            ...
            <div className={styles.surveyRight}>
              <p className={`${utils.s36} ${styles.surveyRightHeading}`}>
                Tech Up, Zen Out - Elevate Your Mind and Body with Live Yoga
                Sessions
              </p>
