...
const About = () => {
  ...
  return (
    <div className="w-full">
      <section className="flex flex-col h-screen space-y-[10vh] 2xl:space-y-[15vh] min-h-[600px] py-20 px-16">
        <div className="grid grid-cols-3 gap-3 w-full items-center">
          <h2 className="font-sentinent col-span-2 text-6xl font-medium">
            Find the limitless potential within by connecting with the Infinite
          </h2>
        ...
        <div
          ref={ref}
          className={`w-full flex flex-col items-center gap-4 text-[var(--text-blue)] ${
        ...
        >
          ...
          <p className="text-lg font-light text-center">
            ...
            almost always find a way to interrupt our daily flow of life. How to
            overcome the constant nudging of frustration that follows? By
      ...
      <div className="flex flex-col w-full text-[var(--text-blue)] bg-[var(--bg-yellow)]">
        <div className="flex flex-col gap-10 py-16 px-16">
          <div className="flex flex-col gap-4 w-3/5">
            ...
            <p className="text-4xl font-semibold font-sentinent">
              We value Joy over Distraction & Health over Exhaustion
            </p>
            <p className="text-lg font-satoshi font-normal">
          ...
          <div className="grid grid-cols-3 gap-10">
            <div className="flex flex-col gap-4 p-4 bg-gray-500/10 rounded-2xl min-w-[17rem] transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl">
              <p className="text-2xl font-bold">Authentic and Trustworthy</p>
              <p>
            ...
            <div className="flex flex-col gap-4 p-4 bg-gray-500/10 rounded-lg min-w-[17rem] transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl">
              <p className="text-2xl font-bold">Undiluted and Pure</p>
              <p>
            ...
            <div className="flex flex-col gap-4 p-4 bg-gray-500/10 rounded-lg min-w-[17rem] transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl">
              <p className="text-2xl font-bold">Thoughtful and Unconditional</p>
              <p>
        ...
        <div className="flex flex-col items-center gap-10 py-16 px-16">
          <div className="w-full py-2">
            <p className="text-5xl font-semibold font-sentinent">Our Team</p>
          </div>
          <div className="grid grid-cols-4 gap-10">
            <div className="flex flex-col gap-4 p-4 bg-gray-500/10 rounded-lg min-w-[17rem] transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl">
              <p className="text-2xl font-bold">Driven by Experience</p>
              <p>
            ...
            <div className="flex flex-col gap-4 p-4 bg-gray-500/10 rounded-lg min-w-[17rem] transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl">
              <p className="text-2xl font-bold">Foundation of Shoonya</p>
              <p>
            ...
            <div className="flex flex-col gap-4 p-4 bg-gray-500/10 rounded-lg min-w-[17rem] transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl">
              <p className="text-2xl font-bold">Passionate Mission</p>
              <p>
            ...
            <div className="flex flex-col gap-4 p-4 bg-gray-500/10 rounded-lg min-w-[17rem] transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl">
              <p className="text-2xl font-bold">Team Dynamic</p>
              <p>
        ...
        {/* <div className="flex flex-col items-center py-16">
            ...
            <div className="flex items-center justify-between w-full max-w-screen-lg px-8">
              <p className="text-4xl font-semibold">Our Programs</p>
              <button
                className="flex items-center gap-2 py-2 px-4 border border-black rounded-full bg-white"
