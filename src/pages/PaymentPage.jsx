              ...
              <div className={styles.paymentSection}>
                <div className={styles.main}>
                  ...
                  <p className={styles.subHeading}>
                    ...
                    Necessitatibus esse perferendis nihil odio quidem asperiores
                    nisi sunt, rerum qui saepe aspernatur reprehenderit
                    incidunt. Cum exercitationem, sint porro ipsam ullam aut!
                  </p>
                  <div
